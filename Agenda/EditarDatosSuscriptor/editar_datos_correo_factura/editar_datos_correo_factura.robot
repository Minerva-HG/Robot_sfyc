...
${Input_Factura}  Xpath: //html[1]/body[1]/div[3]/div[1]/div[2]/dx-scroll-view[1]/div[1]/div[1]/div[1]/div[2]/app-subscriber-data-form[1]/form[1]/div[2]/div[1]/dx-text-box[1]/div[1]/div[1]/input[1]
...
Ingresar nuevo correo de estado Input_Factura
    Ingresar correo
    Sleep   15s
...
Ingresar correo Input_Factura
    Input text    ${Input_Factura}   ${Correo}
