...
Test menu and screen carga de pallets
    [Documentation]    Validacion de menu
    [Tags]    test_dos
    Menu
    Sleep    5s
 
Test drop tipo equipo
