...
${Combos}    http://megang-612/ReportServer/Pages/ReportViewer.aspx?%2fModulos%2fVentas%2fReportes%2fVentas%2fVEN_ReporteVendedoresHH&rs:Command=Render
${Usuario}  joriospe
${Pass}  Mega12345                        
...
${Listado_de_vendedores_hombro_hombro}    xpath=//td[contains(.,'WEB-Listado de Vendedores Hombro a Hombro')]
${Campo_descripcion}    xpath=//input[contains(@maxlength,'7081')]
${Descripcion_reporte}    WEB-Listado de Vendedores Hombro a Hombro
#Combos
...
${Combo_prospectos}    xpath=/html/body/form/table/tbody/tr/td/div[2]/div/table/tbody/tr[2]/td/div/div/table/tbody/tr/td[1]/table/tbody/tr[2]/td[2]/div/select
...
@{Prospectos}=    Create List    ${Prospectos1}    ${Prospectos2}    ${Prospectos3}    ${Prospectos4}    ${Prospectos5}    ${Prospectos6}         
#Registros
...
${Sucursal1}    xpath=/html/body/form/table/tbody/tr/td/div[2]/div/table/tbody/tr[2]/td/div/div/table/tbody/tr/td[1]/table/tbody/tr[1]/td[5]/div/select/option[3]
...
${Prospectos1}    xpath=/html/body/form/table/tbody/tr/td/div[2]/div/table/tbody/tr[2]/td/div/div/table/tbody/tr/td[1]/table/tbody/tr[2]/td[2]/div/select/option[2]
${Prospectos2}    xpath=/html/body/form/table/tbody/tr/td/div[2]/div/table/tbody/tr[2]/td/div/div/table/tbody/tr/td[1]/table/tbody/tr[2]/td[2]/div/select/option[2]
${Prospectos3}    xpath=/html/body/form/table/tbody/tr/td/div[2]/div/table/tbody/tr[2]/td/div/div/table/tbody/tr/td[1]/table/tbody/tr[2]/td[2]/div/select/option[2]
${Prospectos4}    xpath=/html/body/form/table/tbody/tr/td/div[2]/div/table/tbody/tr[2]/td/div/div/table/tbody/tr/td[1]/table/tbody/tr[2]/td[2]/div/select/option[2]
${Prospectos5}    xpath=/html/body/form/table/tbody/tr/td/div[2]/div/table/tbody/tr[2]/td/div/div/table/tbody/tr/td[1]/table/tbody/tr[2]/td[2]/div/select/option[2]
${Prospectos6}    xpath=/html/body/form/table/tbody/tr/td/div[2]/div/table/tbody/tr[2]/td/div/div/table/tbody/tr/td[1]/table/tbody/tr[2]/td[2]/div/select/option[2]
#Botones
...
*** Test Cases ***
Consultar Reporte Listado de Vendedores Hombro a Hombro
    [Tags]    Validando Reporte Listado de Vendedores Hombro a Hombro
    Ingresar al Navegador
    Ingresar usuario contrasena
    #Ventas
    Reportes    
    Listado de vendedores hombro a hombro
    Boton aceptar
    Validando que redireccione a los combos
    FOR    ${counter}    IN RANGE    1    7
        Seleccionando datos    ${Region}[${counter}]    ${Sucursal}[${counter}]    ${Prospectos}[${counter}] 
        Boton ver informe 
...
Listado de vendedores hombro a hombro
    ...
    Wait Until Element Is Visible    ${Listado_de_vendedores_hombro_hombro}
    Click Element    ${Listado_de_vendedores_hombro_hombro}
...
Seleccionando datos
    ...
    [Arguments]     ${Region}    ${Sucursal}    ${Prospectos}
    ...
    Sleep    3s
    #Wait Until Element Is Visible    ${Combo_prospectos}
    Click Element    ${Combo_prospectos}
    Sleep    3s
    #Wait Until Element Is Visible    ${Prospectos}
    Click Element    ${Prospectos}
    Sleep    3s
