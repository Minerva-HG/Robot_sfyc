...
${Comisiones_por_vendedor_semanal}    xpath=(//td[contains(.,'Comisiones por vendedor semanal')])[1]
${Campo_descripcion}    xpath=//input[contains(@maxlength,'7081')]
${Descripcion_reporte}    Comisiones por vendedor semanal  
#Checkbox
...
${Combo_los_que_dependen_de}    xpath=/html/body/app-root/app-side-nav-outer-toolbar/dx-drawer/div/div[2]/dx-scroll-view/div[1]/div/div[1]/div[2]/div/app-reporting-main-container/app-shared-reporting-main-container/div/div/div[1]/div[3]/app-reporting-commission-by-salesman-weekly-form/form/div/div/div/div[2]/app-salesman-chief-by-period-dropdown/dx-drop-down-box/div/div/div[1]/input
#Registros
...
*** Test Cases ***
Consultar Reporte Comisiones por vendedor semanal
    [Tags]    Validando Reporte Comisiones por vendedor semanal
    Ingresar al Navegador
    Ingresar usuario contrasena
    #Ventas
    Reportes    
    Comisiones por vendedor semanal
...
Comisiones por vendedor semanal
    ...
    Wait Until Element Is Visible    ${Comisiones_por_vendedor_semanal}
    Click Element    ${Comisiones_por_vendedor_semanal}
