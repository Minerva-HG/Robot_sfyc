...
#########################Pantalla reporte portación estado detalle###################################################################
...
${Reporte_portacion_estado_detalle}    xpath=//td[contains(.,'Portación estado detalle')]
######################################Botones#############################################################################################################################
...
######################################Combo sucursal##################################################################################
${Combo_sucursal}    xpath=/html/body/app-root/app-side-nav-outer-toolbar/dx-drawer/div/div[2]/dx-scroll-view/div[1]/div/div[1]/div[2]/div/app-reporting-main-container/app-shared-reporting-main-container/div/div/div[1]/div[3]/app-app-reporting-portation-state-datail-form/form/div/app-branch-parameter/div/div/div/div[2]/app-filter-branch-dropdown/app-base-dropdown/dx-drop-down-box/div[1]/div/div[1]/input
...
*** Test Cases ***
Portación estado detalle
    [Documentation]    Reporte portación estado detalle
    [Tags]    Validación del reporte Portación estado detalle
