*** Settings ***
Documentation    Quejas administrativas de sabana mensual
Library    String
...
######################################Combo sucursal##################################################################################
${Combo_sucursal}    xpath=/html/body/app-root/app-side-nav-outer-toolbar/dx-drawer/div/div[2]/dx-scroll-view/div[1]/div/div[1]/div[2]/div/app-reporting-main-container/app-shared-reporting-main-container/div/div/div[1]/div[3]/app-reporting-administrative-complaints-sheet-monthly-form/form/div/app-branch-parameter/div/div/div/div[2]/app-filter-branch-dropdown/app-base-dropdown/dx-drop-down-box/div/div/div[1]/input
...
Validacion de usuarios
    ...
    FOR    ${counter}    IN RANGE    1     2
        ...
        Sleep    4s
        Click Element    ${Reporte_quejas_administrativs_de_sabana_mensual}
    #IF    ${counter} <= ${7}
        #Sleep    10s
        #Close Browser
    #END
