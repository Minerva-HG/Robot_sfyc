*** Settings ***
Documentation    Reporte cartera - totales de ventas por canal   
Library    String
...
#########################Pantalla Reporte cartera - totales de ventas por canal###################################################################
...
${Descripcion_reporte}    Cartera - Totales de ventas por    
${Cartera_totales_de_ventas_por_canal}    xpath=//td[contains(.,'Cartera - Totales de ventas por canal')]
#########################Fechas###################################################################
...
${Fecha_hasta}    xpath=/html/body/div[2]/div/div/div/div[1]/div/div/table/tbody/tr[4]/td[1]
########################Combo sucursal##################################################################
${Combo_sucursal}    xpath=/html/body/app-root/app-side-nav-outer-toolbar/dx-drawer/div/div[2]/dx-scroll-view/div[1]/div/div[1]/div[2]/div/app-reporting-main-container/app-shared-reporting-main-container/div/div/div[1]/div[3]/app-app-reporting-total-sales-per-channel-form/form/div/div/div[1]/app-branch-parameter/div/div/div/div/app-filter-branch-dropdown/app-base-dropdown/dx-drop-down-box/div/div/div[1]/input
...
############################Campo vacio#####################################################
${Campo_vacio}    xpath=/html/body/app-root/app-side-nav-outer-toolbar/dx-drawer/div/div[2]/dx-scroll-view/div[1]/div/div[1]/div[2]/div/app-reporting-main-container/app-shared-reporting-main-container/div/div/div[1]/div[3]/app-app-reporting-total-sales-per-channel-form/form/div/div/div[1]/app-branch-parameter/div/div/div/div/app-filter-branch-dropdown/app-base-dropdown/dx-drop-down-box/div[1]/div/div[2]/span
...
Cartera - Totales de ventas por canal
    [Documentation]    Reporte cartera - totales de ventas por canal
...
Validacion de usuarios
    ...
    FOR    ${counter}    IN RANGE    1     2
        ...
        Sleep    4s
        Click Element    ${Cartera_totales_de_ventas_por_canal}     
    #IF    ${counter} <= ${7}
        #Sleep    10s
        #Close Browser
    #END
